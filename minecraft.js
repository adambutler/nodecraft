$(document).ready(function(){
  ...
  function init() {
    ...
    window.camera = new THREE.PerspectiveCamera( 50, window.innerWidth / window.innerHeight, 1, 20000 );
    window.camera.position.y = getY( worldHalfWidth, worldHalfDepth ) * 100 + 100;
